...
public class jfcomprador extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLdinero.setFont(new java.awt.Font("Arial", 1, 36)); // NOI18N
        jLdinero.setForeground(new java.awt.Color(51, 51, 51));
        jLdinero.setText("jLabel4");
        ...
        jLabel2.setText("Made in Hyeden ALdana & Juan Carlos Godoy Inc");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jfcomprador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jfcomprador().setVisible(true);
            }
        });
    }
